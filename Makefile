...
check_code:
	@flake8 scripts/* author_style/*.py

black:
	@black scripts/* author_style/*.py
...
clean:
	...
	@rm -fr build dist
	@rm -fr author_style-*.dist-info
	@rm -fr author_style.egg-info
...
build_test:
	docker build -t eu.gcr.io/author-style/api .
